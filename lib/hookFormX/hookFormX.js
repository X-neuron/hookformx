...
export function useFormX(defaultValues, validateSchema, submitCallback) {
  ...
  var useInput = function useInput(name) {
    return useFormInput(name, defaultValues, validateSchema, formValues, handleError, isTouched, errors);
  };
...
function useFormInput(name, defaultValues, validateSchema, values, handleError, isTouched, errors) {
